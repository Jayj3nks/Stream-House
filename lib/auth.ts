 ...
 */
export function createAuthToken(userId: string, expiresIn: string = '7d'): string {
 ...
 */
export function validateAuthRequest(request: Request): { userId: string | null; error?: string } {
