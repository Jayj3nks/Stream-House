...
test.describe('House Management', () => {
  ...
  test('should create a new house', async ({ page }) => {
    ...
    await page.fill('textarea[placeholder*="description" i]', 'A house for gaming content creators');
    ...
    // Add rules
    await page.fill('textarea[placeholder*="rules" i]', 'Be respectful and supportive');
    ...
    await expect(page.locator('text="Gaming Legends"')).toBeVisible({ timeout: 5000 });
  });
